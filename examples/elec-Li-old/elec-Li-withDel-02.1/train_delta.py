...
DEFAULT_OUTPUT_ROOT = DATA_ROOT / "local_runs" / "elec-Li-withDel-02.1"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help="Keep only delta pairs whose normal parent frame is at or below this value. Set <0 to disable.",
    )
    ...
    parser.add_argument("--wandb_project", default="MatterTune-Electrolyte-Li-withDel-02.1")
    ...
    run_name = args.wandb_name or f"{__import__('datetime').datetime.now().strftime('%Y%m%d-%H%M%S')}-mattersim-withDel-02.1-first100"
