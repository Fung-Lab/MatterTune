...
DEFAULT_STRUCTURE = Path(
    "/net/csefiles/coc-fung-cluster/lingyu/Electrolyte/get_all_trj_aimd/Li-metal/case3-Li-FSI-FEC/"
    "case1-case3-Li-FSI-FEC-1-13.0/top.pdb"
)
DEFAULT_MD_ROOT = Path("/net/csefiles/coc-fung-cluster/lingyu/Electrolyte/MLIP-MD")
