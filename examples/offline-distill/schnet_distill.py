...
from mattertune.students import SchNetStudentModel
...
def main(args_dict: dict):
    def hparams():
        ...
        hparams.trainer.loggers = [
            WandbLoggerConfig(
                ...
                name=f"schnet--{args_dict['cutoff']}A-T={args_dict['num_message_passing']}-water-{formatted}"
            )
        ]
    ...
    model = SchNetStudentModel.load_from_checkpoint(f"./checkpoints/schnet-{args_dict['cutoff']}A-T={args_dict['num_message_passing']}.ckpt")
    ...
    plt.tight_layout()
    plt.savefig("schnet_water_val_predictions.png", dpi=300)
