...
# plt.plot(gOO_mattersim_r_values, gOO_mattersim_mpx2_g_values, color="#7DAEE0", linestyle="dotted", linewidth=2, label=f"MatterSim-V1-1M-MPX2 (rmse={compute_rmse(gOO_benchmark_r_values, gOO_benchmark_g_values, gOO_mattersim_mpx2_r_values, gOO_mattersim_mpx2_g_values):.3f})")
