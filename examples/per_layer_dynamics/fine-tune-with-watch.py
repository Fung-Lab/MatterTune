...
def main(args_dict: dict):
    def hparams():
        ...
        hparams.trainer.loggers = [
            WandbLoggerConfig(
                project="MatterTune-PerLayerDynamics", 
    ...
    wandb.init(project="MatterTune-PerLayerDynamics", name=f"Li3PO4-{args_dict['model_type']}-MPx{args_dict['pruned_mp_steps']}-{args_dict['down_sample']}", resume=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pruned_mp_steps", type=int, default=3)
