...
class ParallizedInferenceDDP(ParallizedInferenceBase):
    def __init__(
        ...
        *,
        ...
        self.cuda_env.setdefault("NCCL_DEBUG", "INFO") #  can be set to INFO or DEBUG for more verbose output
        ...
        self.proc = subprocess.Popen(self.cmd, env=self.cuda_env, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, start_new_session=True)
