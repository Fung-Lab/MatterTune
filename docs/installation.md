...
pip install ase "e3nn>=0.5" hydra-core lmdb numba "numpy>=2.2,<3" orjson "pymatgen>=2023.10.3" submitit tensorboard "torch==2.5.0" wandb torch_geometric h5py netcdf4 opt-einsum spglib
```
